...
## [Download from GameJolt](https://gamejolt.com/games/gravitydefiedpsp/1060552)
...
This is the C++ port of Gravity Defied for Playstation Portable, which includes all the features of the original game.
...
### PSP Code authors
* Port coding by **[antim0118](https://github.com/antim0118)**
* [gLib2D](https://github.com/libcg/gLib2D) library by **Geecko**
* [intraFont-G](https://github.com/libcg/intraFont-G) library by **Geecko**, **BenHur**, **InsertWittyName**, **[r3trob0y](https://github.com/r3trob0y)**
...
If you want to contribute, feel free to discuss your idea with the rest of the developers in *rgimad's* [Telegram group](https://t.me/+sOfxjrsbkbEwNzc6)
